...
echo 'Cloning Hardware Audio Tree'
	git clone https://github.com/xiaomi-sm8450-marble/android_hardware_qcom_audio-ar.git -b lineage-23.0 hardware/qcom-caf/sm8450/audio/primary-hal
	git clone https://github.com/xiaomi-sm8450-marble/android_vendor_qcom_opensource_arpal-lx.git -b lineage-23.0 hardware/qcom-caf/sm8450/audio/pal
...
echo 'Cloning Common Tree'
        git clone https://github.com/AxionAOSP-devices/android_device_xiaomi_sm8450-common -b lineage-23.0 device/xiaomi/sm8450-common

echo 'Cloning Vendor Common Tree'
        git clone https://github.com/AxionAOSP-devices/android_vendor_xiaomi_sm8450-common -b lineage-23.0 vendor/xiaomi/sm8450-common
